...
public final class Constants
{
    ...
    public static final String LOG_TAG = "PirateBoxLocalePlugin"; //$NON-NLS-1$
     ...
     */
    public static final boolean IS_CORRECT_THREAD_CHECKING_ENABLED =true;
    
    protected static final String INTENT_EXTRA_STATE = "de.fun2code.android.piratebox.plugin.locale.STATE";
